---
title: CS101 Tips
subject: "A beginner's guide to kickstarting programming -- for CS101 and beyond!"
date: 2022-04-08
...
### Installation
Refer to the official [Simplecpp](https://www.cse.iitb.ac.in/~ranade/simplecpp/) page for os-specific installation details.
...
A pseudocode is an informal outline of code that doesn't rely much on syntax, rather, its purpose is to capture the flow of the program. An example provided is below.

![Pseudocode of Polynomial Division](/polynomial-division.svg){: w="100%"}
...
{: .prompt-info}
### **C**onsolidate
Now, **c**onsolidate your approach by finalising data types and verifying its correctness on test cases by performing [dry runs](#dry-run).
#### Finalising Data Types
<!-- Choose appropriate variable data types according to constraints and approach. -->
- Always assign data type to variables according to the data they hold. Look at the constraints and your approach to figure out the range of values each variable can take.\
**Examples**
...
- Whenever feasible, prioritize using integer data types over floating-point data types, which can be imprecise due to floating-point errors. Some problems may initially seem to require floating-point numbers, but with careful consideration, you might find solutions using integers.
...
Now, use [type conversion](https://www.geeksforgeeks.org/type-conversion-in-c/) to compute expressions containing variables of different data types. This also make your program *unambiguous*.
...
{: .prompt-info}
#### Dry Run
A dry run is a manual simulation of the program used to. 
...
- Select a test case
	...
	- Check if the values of variables match with their expected values.
		- If any variable's values don't match at any point, your program is incorrect; consider debugging or rewriting it. 
		- If all variables' values match consistently, Hurray! Your program is correct 'for the current test case'.
...
_Pic Courtesy: [stackoverflow](https://stackoverflow.com/a/84624)_
### Some Common Errors
...
#### Compilation Errors
- Missing semicolons, missing curly braces or missing multiplication symbol (`ab` instead of `a*b`)
...
Below is a [problem set](/CS-101/Problems.pdf)[^problems] that I have worked on over the years.
...
> I also showcase interesting solutions from students [here](/cs101/solutions).
If you have solved a problem and would like to be featured, feel free to reach out to me.
{: .prompt-tip}
<iframe src="/CS-101/Problems.pdf#zoom=70" align="center" width="100%" height="666px"> </iframe> 
...
### Videos
Some select videos that are both fun and helpful
...
<!-- - [Towers of Hanoi: A Complete Recursive Visualization - Reducible](https://youtu.be/rf6uf3jNjbo) -->
...
- [Great Impractical Ideas in Computer Science: PowerPoint Programming - Tom Wildenhain](https://youtu.be/_3loq22TxSc) - A must-watch
...
- [Random Numbers with LFSR (Linear Feedback Shift Register) - Computerphile](https://youtu.be/Ks1pw1X22y4) - Pseudorandom number generation
...
[^problems]: [Param Rathour, *Practice Problems, Computer Programming and Utilization*](/CS-101/Problems.pdf)
