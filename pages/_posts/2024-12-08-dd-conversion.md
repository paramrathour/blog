...
> A big thank you to our guest author [Bhatla](https://anubhavbhatla.github.io/), who will be sharing his अनुभव (experiences) along with me.
{: .prompt-info}

We both joined IIT Bombay as B.Tech. students in Electrial Engineering (EE) and utilised the option to convert to the DD programme offered by our department. While I chose the Control and Computing (CC) as my specialisation, Anubhav chose Electronic Systems (ES).
...
The EE office is also notorious for alloting TAship duties outside of your preferences, which may become a hassle sometimes.
...
[^cpi]: CPI is important at least till you get your first research/work experience outside of the college.
[^ddpcredits]: The DDP is not counted in while calculating the semester credits as they have their own sections in the transcript, still it is advised to not take more than two courses in the final year to properly focus on the project.
