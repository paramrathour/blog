...
> I won't be delving into explaining the specifics of Nen, nor is it required for this blog, but if you are interested, refer to the [wiki](https://hunterxhunter.fandom.com/wiki/Nen).
{: .prompt-info}
...
- There is [En](https://hunterxhunter.fandom.com/wiki/Nen#En), where we see its detection range varying from [four meters](https://hunterxhunter.fandom.com/wiki/Nobunaga_Hazama) to a [couple of kilometres](https://hunterxhunter.fandom.com/wiki/Neferpitou).
- [Condition strengthening](https://hunterxhunter.fandom.com/wiki/Nen#Conditions) is also a prominent theme to increase the powers of Nen attacks, while people with extreme resolve have also utilised the life-threatening Nen contracts such as Kurapika with his Chain Jail, Kite with his Crazy Slots or Gon :( 
...
Also, an honourable mention for those puppets not intended for direct fights ft. [Bisky](https://hunterxhunter.fandom.com/wiki/Biscuit_Krueger) and [Pitou](https://hunterxhunter.fandom.com/wiki/Neferpitou).
### Steal
