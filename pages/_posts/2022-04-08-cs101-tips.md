...
- Now, repeat the above procedure for a different test case :).
...
This [article](https://curc.readthedocs.io/en/latest/programming/coding-best-practices.html) delves into the first three practices in detail. The last two practices would be too much for the small programs we write in CS101 but do try to follow the first three.
#### Naming Conventions
...
I have created these problems with the intention that you will learn something new from each of them while having fun.
...
| [The Coding Train]({{ site.url_prefixes.youtube.home }}/@TheCodingTrain) | Tackles interesting 'simple' problems involving graphics, kinda like my [problem set]({{ site.url }}/CS-101/Problems.pdf) :D |
